# ================================
# Create Sample × Order (prediction) Matrix for 9.1
...
# Step 1: Read CSV
taxa_data <- read_csv("C:/Users/Abdulaziz Khalil/Desktop/Dataset/9.1_final_assignments.csv")
...
write.csv(
  sample_order_matrix,
  "C:/Users/Abdulaziz Khalil/Desktop/Dataset/9.1_sample_order_matrix.csv",
  row.names = FALSE
)
