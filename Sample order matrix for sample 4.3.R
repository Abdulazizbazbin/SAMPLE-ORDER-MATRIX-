# ================================
# Create Sample × Order (prediction) Matrix for 4.3
...
# Step 1: Read CSV
taxa_data <- read_csv("C:/Users/Abdulaziz Khalil/Desktop/Dataset/4.3_final_assignments.csv")
...
write.csv(
  sample_order_matrix,
  "C:/Users/Abdulaziz Khalil/Desktop/Dataset/4.3_sample_order_matrix.csv",
  row.names = FALSE
)
